"""Pydantic v2 schemas for neighborhood analysis."""
...
class CrimeStats(BaseModel):
    ...
    property_crime_rate: Optional[float] = None  # per 100k
    overall_safety_score: Optional[float] = None  # 1-10
...
class NeighborhoodAnalysisResult(BaseModel):
    ...
    data_completeness: float = 0.0  # 0.0-1.0, fraction of sources with data


class NeighborhoodRequest(BaseModel):
    """Request body for the neighborhood analysis endpoint."""
