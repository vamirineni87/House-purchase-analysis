"""Pydantic v2 schemas for financial analysis."""
...
class FinancialAnalysisRequest(BaseModel):
    ...
    down_payment_pcts: list[float] = [0.10, 0.20]
    term_years: list[int] = [15, 30]
    rate_override: float | None = None
    property_tax_rate: float | None = None  # Override county default
